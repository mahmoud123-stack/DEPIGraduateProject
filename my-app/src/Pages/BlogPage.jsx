...
import Articles from "../jobify_articles_1-50.json";
...
export default function BlogPage() {
  ...
  const { GloblalArticle, setGlobalArticle } = useContext(ArticleContext);
      ...
      <div className="container">
        <div className="IntroSection">
          <div className="HeadLine">
            ...
            <p>
              In a world buzzing with trends, tech, and ideas, this blog is
              built to slow things down a little - to explain, explore, and
              inspire. Grab a coffe, scroll through, and pick any topic that
              speaks to you, Every article is built to add value, not take time.
            </p>
          </div>
        </div>

        <div className="Blogs">
          {Articles.articles.slice(start, max).map((art) => {
            return (
              <div
                key={art.id}
                onClick={() => {
                  setGlobalArticle(art);
                  navigate("/blog/article_Details");
                }}
                className="Article"
              >
