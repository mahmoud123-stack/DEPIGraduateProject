...
function Features() {
  ...
  const features = [
    {
      icon: <Brain size={60} color="#5eead4" />,
      title: "Career Analyzer",
      desc: "Analyze your strengths and personality to find the best career fit.",
    },
    {
      icon: <Target size={50} color="#c084fc" />,
      title: "Learning Path Generator",
      desc: "Get personalized learning paths tailored to your goals.",
    },
    {
      icon: <BarChart size={50} color="#f9a8d4" />,
      title: "Salary & Demand Insights",
      desc: "Stay ahead with market trends, salaries, and job demand.",
    },
    {
      icon: <MessageSquare size={50} color="#2dd4bf" />,
      title: "Real Interview Questions",
      desc: "Prepare with actual questions from industry interviews.",
    },
  ];
    ...
    <div className="Features">
      <div className="container">
        <div className="HeadLine">
          ...
          <p> We provide Best Services to help you succeed in your career.</p>
        </div>
