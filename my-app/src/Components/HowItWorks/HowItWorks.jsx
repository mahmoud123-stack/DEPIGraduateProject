  ...
  const stepsData = [
    {
      ...
      title: "take the quiz",
      description:
        " Take our career quiz to understand your strengths and interests.",
    },
    {
      number: "2",
      title: "Get your personal path",
      description:
        "Get your personalized career path based on your quiz results.",
    },
    {
      number: "3",
      title: "Start learning",
      description: "Start learning and growing in your chosen career path.",
    },
  ];
    ...
    <div className="HowItWorks">
      <div className="container">
        <div className="HeadLine">
          ...
          <p>The Clear Path to Success In Your Career</p>
        </div>
            ...
            <div className="steps">
              {stepsData.map((step, index) => (
                <div key={index} className="Step">
                  <span className="dotNumber">{step.number}</span>
